...
public class Settings extends PreferenceActivity
    ...
    private static class HeaderAdapter extends ArrayAdapter<Header> {
        ...
        private final SystemWorkModeEnabler mSystemWorkModeEnabler;
        ...
        static int getHeaderType(Header header) {
            if (header.fragment == null && header.intent == null) {
                return HEADER_TYPE_CATEGORY;
            								...
            								|| header.id == R.id.system_work_mode) {
        ...
        public HeaderAdapter(Context context, List<Header> objects,
            ...
            mSystemWorkModeEnabler = new SystemWorkModeEnabler(context, new Switch(context));
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (headerType) {
                ...
                case HEADER_TYPE_SWITCH:
                    ...
                    } else if(header.id == R.id.system_work_mode){
                    		mSystemWorkModeEnabler.setSwitch(holder.switch_);
                    }
